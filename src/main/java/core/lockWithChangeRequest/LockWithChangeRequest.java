...
public class LockWithChangeRequest implements Lock {
    private String id;
    ...
    public LockWithChangeRequest(LockChangeAction<Lock> lockChangeAction) {
        this.id = UUID.randomUUID().toString();
        this.lockStatus = Status.UNLOCKED;
        this.ownerId = UUID.randomUUID().toString();
        this.tag = new ArrayList<>();
    ...
    public LockWithChangeRequest(List<String> tag) {
        this.id = UUID.randomUUID().toString();
        this.lockStatus = Status.UNLOCKED;
        this.ownerId = UUID.randomUUID().toString();
    ...
    public LockWithChangeRequest(List<String> tag, LockChangeAction<Lock> lockChangeAction) {
        this.id = UUID.randomUUID().toString();
        this.lockStatus = Status.UNLOCKED;
        this.ownerId = UUID.randomUUID().toString();
        this.tag = new ArrayList<>(tag);
